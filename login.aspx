...
<head runat="server">
    ...
    <meta name="author" content="CodesGesture" />
...
<body class="page-login">
    <form id="form1" runat="server">
        <main class="page-content" style="background:#ffc107;">
                                ...
                                <div class="login-box">
                                   <br />
                                    ...
                                    <div class="m-t-md">
                                        ...
                                        <p class="text-center m-t-xs text-sm">Designed and Developed by <br /><b> Codesgesture.com</b></p>
                                </div>
                            </div>
                        </div>
                    </div>
